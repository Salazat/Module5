...
while True:
    ...
    if command == '1':
        while current_enemy.health > 0 and hero.health > 0:
            hero_damege = random.randint(5,15)
            enemy_damege = random.randint(10, 25)


            print(hero.take_damage(enemy_damege))
            print(current_enemy.take_damage(hero_damege))
